...
positiveAOA_correction_fac = Sin(aoa_r)+0.5*mainplane_scale;
negativeAOA_correction_fac = airfoil_t-x_max_t*Tan(aoa_r);
hc_aim = 1;
hc = -(hc_aim + negativeAOA_correction_fac+0.3*airfoil_t);
